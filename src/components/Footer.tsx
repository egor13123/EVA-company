    ...
    <footer className="bg-ink text-paper mt-32">
      <div className="container-x py-20 grid gap-12 md:grid-cols-12">
        ...
        <div className="md:col-span-4">
          ...
          <address className="not-italic text-paper/85 space-y-3 leading-relaxed">
            <p>ООО «ТСК ЕВА»</p>
      ...
      <div className="border-t border-paper/10">
        <div className="container-x py-6 flex flex-col md:flex-row md:items-center md:justify-between gap-3 text-[11px] uppercase tracking-widest text-paper/50">
