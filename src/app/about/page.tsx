  ...
  return (
    <>
      <PageHero
        eyebrow="О компании"
        title={"Делаем\nтендерные закупки\nпредсказуемыми"}
        lead="ТСК ЕВА — компания, которая участвует в тендерах, сфера торговли и строительства. Мы выстраиваем процессы так, чтобы заказчик получал результат вовремя и без рисков."
      />
