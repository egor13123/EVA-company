  ...
  return (
    <>
      <PageHero
        eyebrow="О компании"
        title={"Делаем\nтендерные закупки\nпредсказуемыми"}
        lead="ЕВА ТСК — компания, которая занимается тендерными закупками в сфере торговли и строительства. Мы выстраиваем процессы так, чтобы заказчик получал результат вовремя и без рисков."
      />
